...
import 'package:farmacare/widgets/bottom_drawer.dart';
...
import 'router.dart';
import 'package:farmacare/widgets/settings_bottom_sheet.dart';
import 'package:farmacare/widgets/waterfall_notched_rectangle.dart';
...
class ReplyPageState extends State<ReplyPage> with TickerProviderStateMixin {
                ...
                return ListTile(
                  leading: ImageIcon(
                    ...
                    color: destination.name == currentlySelectedInbox
                        ...
                        : AppColors.white50.withOpacity(0.64),
                  ),
                  title: Text(
                    destination.name,
          ...
          InkWell(
            ...
            child: ListTile(
              leading: ImageIcon(
                ...
                color: AppColors.white50.withOpacity(0.64),
              ),
              title: Text(
                folder,
                style: theme.textTheme.bodyMedium!.copyWith(
